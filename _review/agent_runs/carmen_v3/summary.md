...
- Timestamp (UTC): `2026-02-28T13:26:00.907684+00:00`
- Dry run: `False`
- Mode: `deep`
...
## Execution Stats
- subagent_count: `3`
- stream_total_ms: `52609.74`
- tool_calls_total: `58`
- tool_calls_ok: `58`
- tool_ok_rate: `1.0`
- synth_latency_ms: `37994.81`
- final_answer_chars: `7647`
...
## Stream Details
- `grounding_expert`: ms=14282.67 | tools_ok=8/8 | answer_chars=3356
- `hot_index_context`: ms=18136.32 | tools_ok=18/18 | answer_chars=3735
- `ogh_rs_core`: ms=20190.75 | tools_ok=32/32 | answer_chars=3526
